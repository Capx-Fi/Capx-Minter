...
contract CapxAutoLPTaxableToken is Ownable, IERC20, IERC20Metadata {
    ...
    modifier checkIsAddressValid(address address_)
    {
        require(address_ != address(0), "[Validation] Invalid address");
        require(address_ == address(address_), "[Validation] Invalid address");
        _;
    }
