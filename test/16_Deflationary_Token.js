...
contract('Deflationary token', async (accounts) => {
    ...
    before(async () => {
        ...
        deflationarytoken = (await factoryInstance.createReflectiveToken(tokenName,tokenSymbol,tokenDecimals,tokenTotalSupply,[ownerAddress,'0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D',address2],[true,true,false,false],[200,200,0,0,0])).logs[0].address
