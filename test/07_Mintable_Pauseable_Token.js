...
contract("Mintable Pausable Token", async (accounts) => {
    ...
    before(async () => {
        ...
        let mintablepausabletoken = ((await factoryInstance.createToken(tokenName, tokenSymbol,ownerAddress, tokenDecimals,tokenTotalSupply ,tokenTotalSupply, 6,0)).logs[0].address); 
