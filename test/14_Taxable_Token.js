...
contract("Taxable Tokens", async (accounts) => {
    ...
    before(async () => {
        ...
        taxabletoken = (await factoryInstance.createReflectiveToken(tokenName,tokenSymbol,tokenDecimals,tokenTotalSupply,[ownerAddress,address1,address2],[true,false,false,false],[200,0,0,0,0])).logs[0].address
