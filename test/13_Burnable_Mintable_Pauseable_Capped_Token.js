...
contract("Burnable Mintable Pausable Capped Token", async (accounts) => {
    ...
    before(async () => {
        ...
        let burnmintpausablecappedtoken = ((await factoryInstance.createToken(tokenName, tokenSymbol,ownerAddress, tokenDecimals,tokenTotalSupply ,tokenTotalSupply*6/5, 12,0)).logs[0].address); 
