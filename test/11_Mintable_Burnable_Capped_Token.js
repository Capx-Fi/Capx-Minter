...
contract("Mintable Burnable Capped Token", accounts => {
    ...
    before(async () => {
        ...
        let burnmintcappedtoken = ((await factoryInstance.createToken(tokenName, tokenSymbol,ownerAddress, tokenDecimals,tokenTotalSupply ,tokenTotalSupply * 6 / 5, 10,0)).logs[0].address); 
