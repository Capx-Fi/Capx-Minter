...
contract("Mintable Capped Token", async (accounts) => {
    ...
    before(async () => {
        ...
        let mintablecappedtoken = ((await factoryInstance.createToken(tokenName, tokenSymbol,ownerAddress, tokenDecimals,tokenTotalSupply ,tokenTotalSupply * 6 / 5, 9,0)).logs[0].address); 
