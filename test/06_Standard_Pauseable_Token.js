...
contract("Standard Pausable Token", async (accounts) => {
    ...
    before(async () => {
        ...
        let standardpausabletoken = ((await factoryInstance.createToken(tokenName, tokenSymbol,ownerAddress, tokenDecimals,tokenTotalSupply ,tokenTotalSupply, 5,0)).logs[0].address); 
